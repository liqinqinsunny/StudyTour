...
- (void)resetFinishFrame
{
    ...
    // wjp 修改   宽度 + 10
    self.finishButton.width = _finishLabel.width+10 + 10;
...
- (UIToolbar *)toolbar{
    if (!_toolbar) {
        ...
        // wjp 修改  宽度 + 10      高度 + 10
        _finishButton.frame = CGRectMake(0, 0, _finishLabel.width+10 + 10, _selectButton.height+ 10);
